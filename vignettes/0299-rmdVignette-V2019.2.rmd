...
One possible rendition of this homework assignment in HTML format is [here](https://tedwards-github.github.io/useRfiles/rmd-files/rmd_basicsFINAL01.html).
...
Conversion to PDF directly from RMarkdown is somewhat complex, mostly because it requires installation of TeX.  There's [a separate vignette for PDF output](https://tedwards-github.github.io/useR/articles/0209-rmdPDFOutput.html) that will walk through installation of TeX on your CPU. 
